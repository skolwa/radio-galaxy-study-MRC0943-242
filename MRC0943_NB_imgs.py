...
for spec_feat,lam1,lam2 in zip(spec_feat,lam1,lam2):
	...
	#for Lya, different colour regions on same plot hence arrays below
	Lya1 = [4732.5, 4747.5]
	Lya2 = [4754.3, 4758.8]
	Lya3 = [4768.8, 4776.2]
	Lya4 = [4778.8, 4793.8]
	...
	if spec_feat == 'Lya':
		...
		pl.title(spec_feat+spec_feat+r' integrated flux widths')
